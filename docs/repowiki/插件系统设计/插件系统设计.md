...
- [jsplugins-src/songloft-jsplugin-lxmusic/src/engine/manager.ts](file://jsplugins-src/songloft-jsplugin-lxmusic/src/engine/manager.ts)
- [jsplugins-src/songloft-jsplugin-lxmusic/src/handlers/source.ts](file://jsplugins-src/songloft-jsplugin-lxmusic/src/handlers/source.ts)
...
## 简介
本设计文档面向 Songloft 音频源编排系统，系统采用新的三层架构设计，通过 Fetcher、Resolver、Orchestrator 三个核心组件实现音频源的统一管理、搜索和播放。系统经过重大架构变更，原有的插件系统已被完全移除，新的音频源编排框架提供了更高效、更稳定的音频源管理能力。
...
### 洛雪音源插件（songloft-jsplugin-lxmusic）
- **功能特性**
  - 支持多个音乐平台的音源管理
  - 提供音源的启用/禁用、导入/导出功能
  - 实现音源脚本的动态加载和运行时管理
...
**图表来源**
- [jsplugins-src/songloft-jsplugin-lxmusic/src/handlers/source.ts:598-644](file://jsplugins-src/songloft-jsplugin-lxmusic/src/handlers/source.ts#L598-L644)
- [jsplugins-src/songloft-jsplugin-lxmusic/src/engine/manager.ts:28-53](file://jsplugins-src/songloft-jsplugin-lxmusic/src/engine/manager.ts#L28-L53)

**章节来源**
- [jsplugins-src/songloft-jsplugin-lxmusic/src/main.ts:49-112](file://jsplugins-src/songloft-jsplugin-lxmusic/src/main.ts#L49-L112)
- [jsplugins-src/songloft-jsplugin-lxmusic/src/engine/manager.ts:17-74](file://jsplugins-src/songloft-jsplugin-lxmusic/src/engine/manager.ts#L17-L74)
- [jsplugins-src/songloft-jsplugin-lxmusic/src/handlers/source.ts:321-644](file://jsplugins-src/songloft-jsplugin-lxmusic/src/handlers/source.ts#L321-L644)

### 小米音箱插件（songloft-jsplugin-xiaomi）
- **功能特性**
  - 多账号管理：支持配置和管理多个小米账号
...
**章节来源**
- [jsplugins-src/songloft-jsplugin-xiaomi/src/main.ts:40-126](file://jsplugins-src/songloft-jsplugin-xiaomi/src/main.ts#L40-L126)
...
LX["洛雪音源插件"] --> SDK["@songloft/plugin-sdk"]
LX --> MUSICSRC["@songloft/musicsdk"]
XM["小米音箱插件"] --> SDK
...
- [jsplugins-src/songloft-jsplugin-lxmusic/src/main.ts:18-40](file://jsplugins-src/songloft-jsplugin-lxmusic/src/main.ts#L18-L40)
...
## 结论
Songloft 音频源编排系统通过新的三层架构设计，提供了高效、稳定、可扩展的音频源管理能力。系统将原有的插件系统重构为专门的音频源编排框架，通过 Fetcher、Resolver、Orchestrator 的明确分工，实现了音频源的统一管理、智能搜索和自动切源。

**重要更新**：本次架构变更标志着 Songloft 从通用插件系统转向专业的音频源管理平台。新的系统具有以下关键优势：
...
这些改进使得 Songloft 能够更好地处理复杂的音频源场景，为用户提供更优质的音乐播放体验。
